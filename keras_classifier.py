...
class BaseWrapper(object):
    ...
    def __init__(self, build_fn=None, X_transform_fn=None,  **sk_params):
        self.build_fn = build_fn
        self.X_transform_func = X_transform_fn
    ...
    def get_params(self, deep=True):
        ...
        res.update({'X_transform_fn' : self.X_transform_func})
        return res
    ...
    def fit(self, X, y, **kwargs):
        ...
        transformed_X = self.X_transform_func(X)

        history = self.model.fit(transformed_X, y, **fit_args)
...
class KerasClassifier(BaseWrapper):
    ...
    def score(self, X, y, **kwargs):
        ...
        outputs = self.model.evaluate(transformed_X, y, **kwargs)
